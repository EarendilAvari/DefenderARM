...
static const char ASCII_4x4pix[][4] = {
  ...
  ,{0x0B, 0x00, 0x00, 0x00} // 21 !
  ,{0x03, 0x00, 0x03, 0x00} // 22 "
  ,{0x0F, 0x06, 0x0F, 0x02} // 23 #
  ,{0x0A, 0x0B, 0x0D, 0x05} // 24 $
  ,{0x09, 0x04, 0x02, 0x09} // 25 %
  ,{0x05, 0x0B, 0x05, 0x0A} // 26 &
  ,{0x00, 0x00, 0x01, 0x00} // 27 '
  ,{0x06, 0x09, 0x00, 0x00} // 28 (
  ,{0x09, 0x06, 0x00, 0x00} // 29 )
  ,{0x05, 0x02, 0x05, 0x00} // 2a *
  ,{0x02, 0x07, 0x02, 0x00} // 2b +
  ,{0x08, 0x04, 0x00, 0x00} // 2c ,
  ,{0x02, 0x02, 0x02, 0x02} // 2d -
  ,{0x00, 0x08, 0x00, 0x00} // 2e .
  ,{0x08, 0x04, 0x02, 0x01} // 2f /
  ,{0x0F, 0x09, 0x09, 0x0F} // 30 0
  ,{0x09, 0x09, 0x0F, 0x08} // 31 1
  ,{0x09, 0x0D, 0x0B, 0x09} // 32 2
  ,{0x09, 0x09, 0x0B, 0x0F} // 33 3
  ,{0x07, 0x04, 0x04, 0x0F} // 34 4
  ,{0x07, 0x0D, 0x0D, 0x0D} // 35 5
  ,{0x0F, 0x0A, 0x0A, 0x0E} // 36 6
  ,{0x01, 0x01, 0x01, 0x0F} // 37 7
  ,{0x07, 0x0D, 0x0B, 0x0E} // 38 8
  ,{0x07, 0x05, 0x05, 0x0F} // 39 9
  ,{0x00, 0x05, 0x00, 0x00} // 3a :
  ,{0x08, 0x05, 0x00, 0x00} // 3b ;
  ,{0x02, 0x05, 0x00, 0x00} // 3c <
  ,{0x05, 0x05, 0x05, 0x00} // 3d =
  ,{0x05, 0x02, 0x00, 0x00} // 3e >
  ,{0x01, 0x01, 0x0B, 0x03} // 3f ?
  ,{0x0F, 0x09, 0x06, 0x04} // 40 @
  ,{0x0F, 0x05, 0x05, 0x0F} // 41 A
  ,{0x0F, 0x05, 0x0A, 0x04} // 42 B
  ,{0x0F, 0x09, 0x09, 0x09} // 43 C
  ,{0x0F, 0x09, 0x09, 0x06} // 44 D
  ,{0x0F, 0x0B, 0x0B, 0x09} // 45 E
  ...
  ,{0x0F, 0x01, 0x03, 0x0F} // 4d M
  ,{0x0F, 0x01, 0x02, 0x0F} // 4e N
  ,{0x0F, 0x09, 0x09, 0x0F} // 4f O
  ,{0x0F, 0x05, 0x05, 0x07} // 50 P
  ,{0x0F, 0x09, 0x0D, 0x0F} // 51 Q
  ,{0x0F, 0x05, 0x0D, 0x07} // 52 R
  ,{0x07, 0x0D, 0x0D, 0x0D} // 53 S
  ,{0x01, 0x0F, 0x01, 0x01} // 54 T
  ,{0x0F, 0x08, 0x08, 0x0F} // 55 U
  ,{0x07, 0x08, 0x08, 0x07} // 56 V
  ,{0x0F, 0x08, 0x0C, 0x0F} // 57 W
  ,{0x09, 0x06, 0x06, 0x09} // 58 X
  ,{0x07, 0x0C, 0x04, 0x07} // 59 Y
  ,{0x09, 0x0D, 0x0B, 0x09} // 5a Z
  ,{0x0F, 0x09, 0x00, 0x00} // 5b [
  ,{0x01, 0x02, 0x04, 0x08} // 5c '\'
  ,{0x09, 0x0F, 0x00, 0x00} // 5d ]
  ,{0x02, 0x01, 0x02, 0x00} // 5e ^
  ,{0x08, 0x08, 0x08, 0x08} // 5f _
  ,{0x01, 0x02, 0x00, 0x00} // 60 `
  ,{0x0F, 0x05, 0x05, 0x0F} // 41 A
  ,{0x0F, 0x05, 0x0A, 0x04} // 42 B
  ,{0x0F, 0x09, 0x09, 0x09} // 43 C
  ,{0x0F, 0x09, 0x09, 0x06} // 44 D
  ...
  ,{0x07, 0x0C, 0x04, 0x07} // 59 Y
  ,{0x09, 0x0D, 0x0B, 0x09} // 5a Z
  ,{0x04, 0x0B, 0x09, 0x00} // 7b {
  ,{0x00, 0x0F, 0x00, 0x00} // 7c |
  ,{0x09, 0x0B, 0x04, 0x00} // 7d }
  ,{0x0B, 0x04, 0x0B, 0x04} // 7e ~
};
...
void Nokia5110_PrintBMP(unsigned char xpos, unsigned char ypos, const unsigned char *ptr, unsigned char threshold)
{
  ...
  // bitmaps are encoded backwards, so start at the bottom left corner of the image
	// screeny and screenx are used to determine the position of the character of the array "Screen" we want to modify
  screeny = ypos/8;									// screeny is equivalent to the row of the display where we want
																		// to work. The exact bit we want to process is decided by the value of
																		// the variable mask.
  screenx = xpos + SCREENW*screeny; // We start with the pixel in the left corner of the image.
																		// Since the bmp file is processed upside down.
  ...
  j = ptr[10];                  // byte 10 contains the offset where image data can be found
	// In the following for the image is scanned in every position of the array pointed by ptr
	// To understand this, we have to take into account that in the bmp every pixel is saved as an F,
	// (meaning black). On the other hand, in the array that we want to send to the display
	// every pixel is saved as a bit. Also in the bmp two pixels arranged one beside the other (right and left)
	// are equivalent to a byte, in the array we want to send to the display one byte is equivalent to 8 pixels located
	// in vertical order (up to down).
  for(i=1; i<=(width*height/2); i=i+1)
  {
    ...
    screenx = screenx + 1;
    j = j + 1;
    if((i%(width/2)) == 0) // If we are at the end of the row of the bmp file
    {
      if(mask > 0x01)			 // If we are processing not the upper most bit of the byte
													 // We move the mask one bit to start processing the next bit up
													 // Else we move to the next byte up and we set the mask to 0x80 meaning
													 // we will process the down last bit of the byte.
      {
        mask = mask>>1;
      }
      else
      ...
      screenx = xpos + SCREENW*screeny;  // We come back to the element of "Screen" we were processing at the beginning
...
void Nokia5110_OutString_4x4pix_toBuffer(unsigned char xpos, unsigned char ypos, char *ptr)
{
  while(*ptr)
	{
    Nokia5110_OutChar_4x4pix_toBuffer(xpos, ypos, (unsigned char)*ptr); // We print one character to the buffer
    ...
    ptr = ptr + 1;																											// We update the pointer to the next letter in the string
  }
}
